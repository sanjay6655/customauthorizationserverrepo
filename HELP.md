...
* [OAuth2 Authorization Server](https://docs.spring.io/spring-boot/4.0.0-SNAPSHOT/reference/web/spring-security.html#web.security.oauth2.authorization-server)
